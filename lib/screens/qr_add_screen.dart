...
class _QRAddScreenState extends State<QRAddScreen> with WidgetsBindingObserver {
  ...
  Future<void> _processQRCode(String qrData) async {
    ...
    try {
      ...
      print('Parsed device data: $deviceData');
      ...
      if (context.mounted) {
        ...
        print('Device added to provider, notifying listeners');
      }
            ...
            child: _hasPermission
              ...
              onDetect: (capture) {
                ...
                if (barcode.rawBytes != null) {
                  print('Raw bytes length: ${barcode.rawBytes!.length}');
                  ...
                  if (qrData == null) {
                    ...
                    try {
                      ...
                      print('Decoded with UTF-8: $qrData');
                    } catch (e) {
                    ...
                    if (qrData == null || qrData.isEmpty) {
                      try {
                        ...
                        print('Decoded with Latin-1: $qrData');
                      } catch (e) {
                ...
                if (qrData != null && qrData.isNotEmpty) {
                 ...
                 // qrData = _preprocessQrData(qrData);
                  print('Final QR data after preprocessing: $qrData');
                  _processQRCode(qrData);
                } else {
                  print('Could not extract data from QR code');
                }
              },
...
//////////////////
  ...
  //  final macRegex = RegExp(r'"mac"\s*:\s*"([A-F0-9]+)"', caseSensitive: false);
    ...
    print('Regex extract - MAC: $mac, Type: $type, Name: $name');
  ...
  Map<String, dynamic>? _parseQRData(String qrData) {
    ...
    try {
      ...
      print('Parsed - MAC: $mac, Type: $type, Name: $cleanName');
  ...
  String? _extractJsonFromString(String input) {
    ...
    if (startIndex != -1 && endIndex != -1 && endIndex > startIndex) {
      ...
      try {
        ...
        try {
          jsonDecode(cleaned);
          print('Found JSON after cleaning: $cleaned');
          return cleaned;
        } catch (e) {
          print('Candidate is not valid JSON');
        }
      }
    }
  ...
  String? _findJsonWithRegex(String input) {
    ...
    if (match != null) {
      ...
      try {
        jsonDecode(candidate);
        print('Found JSON with regex: $candidate');
        return candidate;
      } catch (e) {
        ...
        try {
          jsonDecode(cleaned);
          print('Found JSON with regex after cleaning: $cleaned');
          return cleaned;
        } catch (e) {
          print('Regex match is not valid JSON');
        }
      }
    }
